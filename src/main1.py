...
from rutaOptima import algoritmoGenetico
...
def generarRuta():
    ...
    mejorRuta = algoritmoGenetico(coordenadas, poblacion,elite, tasaMutacion, generaciones)

    #Se guardan estados globales para acceder desde el endpoint del mapa
